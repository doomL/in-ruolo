    ...
    var initChat = function (parentEl) {
        ...
        var handleMessaging = function () {
            ...
            var html =
                ...
                '<img src="~/Content/media/users/100_12.jpg" alt="image">' +
                '</span>' +
                '</div>' +
            ...
            setTimeout(function () {
                ...
                var html =
                    '<div class="kt-chat__user">' +
                    '<span class="kt-userpic kt-userpic--circle kt-userpic--sm">' +
                    '<img src="~/Content/media/users/100_13.jpg" alt="image">' +
                    '</span>' +
...
KTUtil.ready(function () {
    KTLayout.init();
    console.log("ktutil.ready");
    function myTimer() {
        toastr.options = { onclick: function () { alert("You clicked Me!"); } }
        toastr.warning('Per un funzionamento ottimale del sito completa la sezione formazione!')
    }
    var completato = true
    $.ajax({
        url: 'Formazione/Completamento',
        success: function (response) {
            console.log(response)
            if (response=="False") {
                var alert = setInterval(myTimer, 10000);
            }
            }
    });
